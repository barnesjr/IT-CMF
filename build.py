#!/usr/bin/env python3
"""Build script for IT Capability Maturity Assessment Tool.
...
def run_dev():
    ...
    # Start backend
    print("Starting backend on :8761...")
...
def build_package():
    ...
    if spec_path.exists():
        ...
        subprocess.run([
            ...
            "--onefile",
            "--add-data", f"backend/static:static",
            "--add-data", f"framework:framework",
...
def assemble_distribution():
    ...
    print(f"Contents: {exe_name}, README.txt, templates/, framework/, exports/")

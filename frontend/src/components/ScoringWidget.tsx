...
const SCORE_DESCRIPTIONS: Record<number, string> = {
  ...
  2: 'Some processes exist but inconsistent',
  3: 'Documented, standardized, regularly reviewed',
  4: 'Integrated, measured, optimized',
  5: 'Predictive, continuous improvement, industry-leading',
};

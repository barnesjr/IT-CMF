...
const RUBRIC_LEVELS = ['initial', 'basic', 'intermediate', 'advanced', 'optimizing'] as const;
...
export function AssessmentItemCard({ item, frameworkItem, onUpdate, expanded: externalExpanded, onToggleExpand }: AssessmentItemCardProps) {
    ...
    <div className="border border-border rounded-xl bg-surface-medium transition-colors hover:border-border-hover">
      ...
      <div className="flex items-start gap-3 p-5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <span className="text-[10px] text-text-tertiary font-mono mt-1 inline-block">{item.id}</span>
        </div>

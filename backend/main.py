...
app = FastAPI(title="IT Capability Maturity Assessment Tool", version="1.0.0")
...
async def export_deliverable(export_type: str):
    valid_types = [
        ...
        "outbrief", "heatmap", "quick-wins", "cc-roadmap", "all",
    ]
    ...
    try:
        ...
        method_map = {
            ...
            "cc-roadmap": export_engine.export_cc_roadmap,
        }
        if export_type == "all":
